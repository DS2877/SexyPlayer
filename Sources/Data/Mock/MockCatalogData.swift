...
public enum MockCatalogData {
    ...
    static let movies: [RawVODItem] = [
        ...
        RawVODItem(providerKey: "m-phantom", name: "The Phantom of the Opera (1925) Restored 1080p", groupTitle: "Movies | Horror", logo: nil, streamURL: "https://example.com/vod/phantom.mp4", plot: "A disfigured composer haunts the Paris Opera House and falls obsessively in love with a young soprano.", genreText: "Horror, Drama", releaseDate: "1925-11-25", durationSecs: 93 * 60, cast: "Lon Chaney, Mary Philbin", director: "Rupert Julian"),
        RawVODItem(providerKey: "m-whitezombie", name: "White Zombie 1932 [Lugosi] SweSub 1080p", groupTitle: "Horror", logo: nil, streamURL: "https://example.com/vod/whitezombie.mp4", plot: "A young man turns to a sinister voodoo master to win the woman he loves, with monstrous consequences.", genreText: "Horror", releaseDate: "1932-07-28", durationSecs: 67 * 60, cast: "Bela Lugosi, Madge Bellamy", director: "Victor Halperin"),
        RawVODItem(providerKey: "m-hauntedhill", name: "House on Haunted Hill (1959) Vincent Price 1080p", groupTitle: "Movies | Horror", logo: nil, streamURL: "https://example.com/vod/hauntedhill.mp4", plot: "An eccentric millionaire offers five guests $10,000 each to survive a night in a haunted house.", genreText: "Horror, Mystery, Thriller", releaseDate: "1959-02-17", durationSecs: 75 * 60, cast: "Vincent Price, Carol Ohmart", director: "William Castle"),
        RawVODItem(providerKey: "m-littleshop", name: "The Little Shop of Horrors 1960 720p", groupTitle: "Movies | Comedy", logo: nil, streamURL: "https://example.com/vod/littleshop.mp4", plot: "A clumsy flower-shop assistant cultivates a plant that feeds on human blood.", genreText: "Comedy, Horror", releaseDate: "1960-08-05", durationSecs: 72 * 60, cast: "Jonathan Haze, Jackie Joseph", director: "Roger Corman"),
        RawVODItem(providerKey: "m-lastman", name: "The Last Man on Earth (1964) [Sci-Fi] 1080p", groupTitle: "Movies | Sci-Fi", logo: nil, streamURL: "https://example.com/vod/lastman.mp4", plot: "The sole survivor of a plague that turned humanity into vampires hunts the infected by day and barricades himself by night.", genreText: "Sci-Fi, Horror, Drama", releaseDate: "1964-03-08", durationSecs: 86 * 60, cast: "Vincent Price, Franca Bettoia", director: "Ubaldo Ragona"),
        RawVODItem(providerKey: "m-mclintock", name: "SE | McLintock! (1963) John Wayne SweSub 1080p", groupTitle: "Movies | Western", logo: nil, streamURL: "https://example.com/vod/mclintock.mp4", plot: "A wealthy cattle baron tries to keep the peace among homesteaders, politicians and his estranged wife.", genreText: "Western, Comedy, Romance", releaseDate: "1963-11-13", durationSecs: 127 * 60, cast: "John Wayne, Maureen O'Hara", director: "Andrew V. McLaglen"),
        RawVODItem(providerKey: "m-thekid", name: "The Kid 1921 - Chaplin - Restored 1080p", groupTitle: "Comedy", logo: nil, streamURL: "https://example.com/vod/thekid.mp4", plot: "The Tramp raises an abandoned child, and the pair scrape a living until the boy's mother reappears.", genreText: "Comedy, Drama, Family", releaseDate: "1921-02-06", durationSecs: 68 * 60, cast: "Charlie Chaplin, Jackie Coogan", director: "Charlie Chaplin"),
        RawVODItem(providerKey: "m-stranger", name: "The Stranger (1946) Orson Welles [Noir] 1080p", groupTitle: "Movies | Thriller", logo: nil, streamURL: "https://example.com/vod/stranger.mp4", plot: "A war-crimes investigator tracks a fugitive Nazi to a quiet Connecticut town where he has built a new life.", genreText: "Thriller, Crime, Drama", releaseDate: "1946-05-25", durationSecs: 95 * 60, cast: "Orson Welles, Edward G. Robinson, Loretta Young", director: "Orson Welles"),
        RawVODItem(providerKey: "m-scarletstreet", name: "Scarlet Street 1945 [Fritz Lang] SweSub", groupTitle: "Thriller", logo: nil, streamURL: "https://example.com/vod/scarletstreet.mp4", plot: "A mild-mannered cashier and amateur painter is ensnared by a manipulative young woman and her boyfriend.", genreText: "Crime, Drama, Thriller", releaseDate: "1945-12-28", durationSecs: 102 * 60, cast: "Edward G. Robinson, Joan Bennett", director: "Fritz Lang"),
        RawVODItem(providerKey: "m-hitchhiker", name: "The Hitch-Hiker (1953) Ida Lupino 720p", groupTitle: "Movies | Thriller", logo: nil, streamURL: "https://example.com/vod/hitchhiker.mp4", plot: "Two friends on a fishing trip pick up a hitchhiker who turns out to be a spree killer.", genreText: "Crime, Thriller, Drama", releaseDate: "1953-03-20", durationSecs: 71 * 60, cast: "Edmond O'Brien, Frank Lovejoy", director: "Ida Lupino"),
        RawVODItem(providerKey: "m-gulliver", name: "Gulliver's Travels (1939) Fleischer [Animation] 1080p", groupTitle: "Movies | Animation", logo: nil, streamURL: "https://example.com/vod/gulliver.mp4", plot: "Shipwrecked Gulliver washes ashore in Lilliput and tries to stop a war between two tiny kingdoms.", genreText: "Animation, Family, Adventure, Fantasy", releaseDate: "1939-12-22", durationSecs: 76 * 60, cast: "Sam Parker, Pinto Colvig", director: "Dave Fleischer"),
        RawVODItem(providerKey: "m-meetjohndoe", name: "Meet John Doe 1941 Frank Capra 1080p", groupTitle: "Movies | Drama", logo: nil, streamURL: "https://example.com/vod/meetjohndoe.mp4", plot: "A newspaper invents a everyman hero to boost circulation, then has to find a man to play him.", genreText: "Comedy, Drama, Romance", releaseDate: "1941-05-03", durationSecs: 122 * 60, cast: "Gary Cooper, Barbara Stanwyck", director: "Frank Capra"),
    ]
    ...
    static let episodes: [RawSeriesEpisode] = [
        ...
        RawSeriesEpisode(providerKey: "e-ranger-s01e01", name: "The Lone Ranger (1949) S01E01 - Enter the Lone Ranger 720p", groupTitle: "Series | Western", logo: nil, streamURL: "https://example.com/series/ranger/s01e01.mp4", plot: "The sole survivor of an ambushed Texas Ranger patrol is nursed back to health by Tonto and takes up a masked identity."),
        RawSeriesEpisode(providerKey: "e-ranger-s01e02", name: "The Lone Ranger 1x02 - The Lone Ranger Fights On", groupTitle: "Series | Western", logo: nil, streamURL: "https://example.com/series/ranger/s01e02.mp4", plot: "The Ranger and Tonto track the outlaw Cavendish gang through the hills."),
